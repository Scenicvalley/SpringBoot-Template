...
public class RedisUtil {
     ...
     * zSet来存放,排名就计算总里程排名吧
     */
    public boolean zSet(String key, float score,String number) {
        try {

            return redisTemplate.opsForZSet().add(key,number,score);
